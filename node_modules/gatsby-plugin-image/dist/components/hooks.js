...
function withArtDirection(defaultImage, artDirected) {
    ...
    (_a = output.images.sources).push.apply(_a, __spreadArray([], __read(images.sources)));
    if (placeholder === null || placeholder === void 0 ? void 0 : placeholder.sources) {
        (_c = output.placeholder) === null || _c === void 0 ? void 0 : (_b = _c.sources).push.apply(_b, __spreadArray([], __read(placeholder.sources)));
    }
    return output;
}
