...
var chalk = require("chalk"); // Should be the same as https://github.com/gatsbyjs/gatsby/blob/master/packages/gatsby-transformer-sharp/src/supported-extensions.js
...
module.exports = function (_ref, pluginOptions) {
  var files = _ref.files,
      ...
      getRemarkFileDependency = _ref.getRemarkFileDependency;
  ...
  var generateImagesAndUpdateNode = /*#__PURE__*/function () {
    var _ref4 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee3(node, resolve, inLink, overWrites) {
      var parentNode, imagePath, imageNode, fluidResult, originalImg, fallbackSrc, srcSet, presentationWidth, srcSplit, fileName, fileNameNoExt, defaultAlt, isEmptyAlt, alt, title, loading, decoding, imageStyle, imageTag, formatConfigs, enabledFormatConfigs, sourcesHtmlPromises, sourcesHtml, placeholderImageData, args, _require4, Potrace, argsKeys, tracedSVG, ratio, wrapperStyle, imageCaption, removeBgImage, imageStats, bgImage, rawHTML;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 7:
              ...
              _context3.next = 10;
              return getRemarkFileDependency({
                absolutePath: {
                  eq: imagePath
                }
              });
  ...
  markdownImageNodes.map(function (_ref8) {
    ...
    return new Promise(function (resolve) {
      ...
      var fileType = getImageInfo(node.url).ext; // Only attempt to convert supported extensions
              ...
              return _regenerator.default.wrap(function _callee4$(_context4) {
                while (1) {
                  switch (_context4.prev = _context4.next) {
                    ...
                    case 16:
                      fileType = getImageInfo(formattedImgTag.url).ext; // Only attempt to convert supported extensions

                      if (!(isRelativeUrl(formattedImgTag.url) && supportedExtensions[fileType])) {
                        _context4.next = 26;
                        break;
                      }
